...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Invechcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"invechcointools.com", "dnsseed.invechcointools.com"},
    {"invechcoinpool.org", "dnsseed.invechcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"invechcointools.com", "testnet-seed.invechcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Invechcoin is probably already running."), addrBind.ToString().c_str());
        else
