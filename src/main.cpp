...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Invechcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Invechcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Invechcoin: 2.5 minutes
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Invechcoin: increase each by adding 2 to bitcoin's value.
